...
<html>
    ...
    %>
        <form name="newArticle" action="createArticles" method="POST" accept-charset="UTF-8">
            <input name="name" type="text">
            <input name="description" type="text">
            <input type="submit">
        </form>

    <form action="readArticles" method="GET" accept-charset="UTF-8">
    <p>Get value of id</p>
    <input name="id" />
    <input type="submit" value="get value of id" />
    </form>
